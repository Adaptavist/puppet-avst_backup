...
class avst_backup::hiera(
    ...
    file { $config_dir:
        ...
        purge   => $run_as_one_job_bool,
        recurse => $run_as_one_job_bool,
    }

    if ($backup_hiera == true){
    ...
    if ( $run_as_one_job_bool ) {
        ...
        if (str2bool($job_failure_email) and str2bool($job_failure_email)) {
        ...
        if (str2bool($job_log_file) and str2bool($job_log_file)) {
        ...
        file { $job_runner_script:
            ...
            mode    => '0755',
            content => template("${module_name}/job_runner.erb"),
        }
        ...
        file { $job_runner_pause:
            ...
            mode    => '0755',
            content => template("${module_name}/pause-backups.erb"),
        }
        ...
        file { $job_runner_resume:
            ...
            mode    => '0755',
            content => template("${module_name}/resume-backups.erb"),
        }
